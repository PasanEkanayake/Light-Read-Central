...
?>
		...
		function show_navigation() {
			 ...
			 */
			$html .= sprintf('<li><a href="#%1$s" class="bdt-tab-item" id="bdt-%1$s" data-tab-index="%2$s">%3$s</a></li>', 'element_pack_seo_performance', $count, esc_html__('SEO Performance', 'bdthemes-element-pack'));
			$count = $count + 1;
			/**
			 * /Wincher Implementation
			 */
							...
							<div class="bdt-widget-filter-wrapper bdt-grid">
												...
												<div>
													<ul class="bdt-subnav bdt-subnav-pill ep-widget-filter ep-used-unused-widgets bdt-flex-inline">
														...
														<li class="ep-widget--" bdt-filter-control="filter: [data-content-type*='ep-unused']; group: data-content-type">
															<a href="#" bdt-tooltip="<?php esc_html_e('Don\'t need unused widget? Click on the Deactivate All button.', 'bdthemes-element-pack'); ?>"><?php esc_html_e('Unused', 'bdthemes-element-pack'); ?>
								...
								<div class="bdt-width-auto@l bdt-search-active-wrap bdt-flex bdt-flex-middle bdt-flex-between">
									<div class="bdt-widget-search">
										<input data-id="ep-options-parent-<?php echo esc_attr($i); ?>" onkeyup="filterSearch(this);" bdt-filter-control="" class="bdt-search-input bdt-flex-middle" type="search" 
